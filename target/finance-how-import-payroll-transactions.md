...
4. Edit or post the journal lines as for any other general ledger transactions. Další informace naleznete v tématu [Zaúčtování transakcí přímo do hlavní knihy](finance-how-post-transactions-directly.md).
