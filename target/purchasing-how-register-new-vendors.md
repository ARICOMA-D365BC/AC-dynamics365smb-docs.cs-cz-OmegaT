...
> [!TIP]
> It can be helpful to personalize the **Vendor Template** page when you create a template. Můžete například chtít přidat pole, které se na stránce ještě nezobrazují. Více informací viz [Přizpůsobení pracovního prostoru](/dynamics365/business-central/ui-personalization-user#to-start-personalizing-a-page-through-the-personalizing-banner).
