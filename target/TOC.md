...
### [Prohlížení a úpravy v excelu](across-work-with-excel.md)
...
### [Prodej zboží montáže na zakázku](assembly-how-to-sell-items-assembled-to-order.md)
...
### [Vrácení účtování montáže](assembly-how-to-undo-assembly-posting.md)
### [Práce s kusovníky](inventory-how-work-BOMs.md)
### [Podrobnosti návrhu: Účtování montážní zakázky](design-details-assembly-order-posting.md)
...
#### [Zaskladnění zboží pomocí zaskladnění](warehouse-how-to-put-items-away-with-warehouse-put-aways.md)
#### [Zaskladnění výroby nebo montáže](warehouse-how-to-put-away-production-output.md)
#### [Plan Put-Aways in Worksheets](warehouse-how-to-plan-put-aways-in-worksheets.md)
#### [Vyskladnění a zaskladnění bez původního dokladu](warehouse-how-to-create-put-aways-from-internal-put-aways.md)
### Move Items
...
#### [Přesun zboží v pokročilých konfiguracích skladu](warehouse-how-to-move-items-in-advanced-warehousing.md)
#### [Přesuňte komponenty do provozní oblasti v základních konfiguracích skladu](warehouse-how-to-move-components-to-an-operation-area-in-basic-warehousing.md)
#### [Výpočet doplnění přihrádky](warehouse-how-to-calculate-bin-replenishment.md)
#### [Naplánujte pohyby skladu v sešitech](warehouse-how-to-plan-warehouse-movements-in-worksheets.md)
### Vyskladnění zboží
...
#### [Vyskladnění pro výrobu nebo montáž v pokročilých konfiguracích skladu](warehouse-how-to-pick-for-internal-operations-in-advanced-warehousing.md)
#### [Plánujte vyskladnění v sešitech](warehouse-how-to-plan-picks-in-worksheets.md)
#### [Vyskladnění a zaskladnění bez původního dokladu](warehouse-how-to-create-put-aways-from-internal-put-aways.md)
...
#### [Vícenásobné smlouvy](service-multiple-contracts.md)
...
#### [Změňte roční částku na servisní smlouvy a nabídku smluv.](service-how-to-change-the-annual-amount-on-service-contracts-or-contract-quotes.md)
### Deliver Service
...
#### [Nastavení profilů odesílání dokumentů](sales-how-setup-document-send-profiles.md)
#### [Send Documents by Email](ui-how-send-documents-email.md)
#### [Nastavení způsobu dodávky](sales-how-set-up-shipment-methods.md)
...
### [Přehled](reports-use-reports.md)
...
### Finance
#### [Finanční analytika](bi.md)
#### [Analýza finančních výkazů pomocí aplikace Excel](finance-analyze-excel.md)
...
### [Práce se sestavami Power BI](across-working-with-powerbi.md)
### [Finanční analytika](bi.md)
### [Analýza finančních výkazů pomocí aplikace Excel](finance-analyze-excel.md)
### [Konsolidace finančních údajů z více společností](finance-consolidated-company-reporting.md)
...
### [Používání Power BI s Business Central](admin-powerbi.md)
### [Analýza finančních výkazů pomocí aplikace Excel](finance-analyze-excel.md)
### [Extrahování dat do datových skladů nebo datových jezer](/dynamics365/business-central/dev-itpro/performance/performance-developer#efficient-extracts-to-data-lakes-or-data-warehouses)
