...
> [!NOTE]
> A sandbox environment created in this way only contains the default demonstration data for the CRONUS company. Z provozního prostředí nejsou kopírována ani jinak přenášena žádná data.
>
